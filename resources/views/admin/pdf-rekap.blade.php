        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="center" valign="middle">
                    <table border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto; width: auto; border: none;">
                        <tr>
            ...
            @if($laporans->count() == 0)
            <tr>
                <td colspan="5">Tidak ada laporan pada periode ini.</td>
            </tr>
            @endif
        </tbody>
    </table>
    ...
    <div class="signature-area">
        <div class="signature-box">
            ...
            @if($user->ttd && file_exists(public_path('storage/' . $user->ttd)))
                <img src="{{ public_path('storage/' . $user->ttd) }}" style="max-width: 100px; max-height: 100px; margin-bottom: 5px;">
            @else
                <br><br><br><br>
            @endif
